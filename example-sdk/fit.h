...
// Profile Version = 9.0.0Release
// Tag = production/release/21.0.215-0-g907088c2
// Product = EXAMPLE
...
#define FIT_PROTOCOL_VERSION_20              ( FIT_CAST( FIT_UINT8, 2 << FIT_PROTOCOL_VERSION_MAJOR_SHIFT ) | 0 )
    ...
    #define FIT_PROFILE_VERSION_MAJOR            9
...
#define FIT_MAX_FIELD_COUNT       (FIT_CAST(FIT_UINT8, 255))
...
#define FIT_MESG_DEF_HDR_SIZE     (FIT_CAST(FIT_UINT8, 5))
